...
function LoadView() {
    ...
    $("#navbarSupportedContent li a[title='全部课程']").addClass("active");
...
function LoadTraining() {
    ...
    var camlQuery = new SP.CamlQuery();
    var view = "<View Scope='RecursiveAll'><Query><OrderBy><FieldRef Name='OrderIndex' /></OrderBy>"+
    "<Where><Eq><FieldRef Name='IsIndex' /><Value Type='Boolean'>1</Value></Eq></Where></Query></View>";
    ...
    function onQueryFailed(sender, args) {
        console.log("获取轮播图失败： " + args.get_message());
    }
}

...
<WebPartPages:ListFormWebPart runat="server" __MarkupType="xmlmarkup" WebPart="true" __WebPartId="{27FB0887-122F-448A-BEFB-C389B1060A72}" >
<WebPart xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://schemas.microsoft.com/WebPart/v2">
  ...
  <ID>g_27fb0887_122f_448a_befb_c389b1060a72</ID>
  <ListName xmlns="http://schemas.microsoft.com/WebPart/v2/ListForm">{C77401E1-D9E0-4D1C-8C8E-8E32A58A46B5}</ListName>
  <ListId xmlns="http://schemas.microsoft.com/WebPart/v2/ListForm">c77401e1-d9e0-4d1c-8c8e-8e32a58a46b5</ListId>
...
<div id="like_view">
    <a href="###" onclick="AddLike()" id="addlike"><img alt="like" height="18" src="../../HomePage/Images/10.png"></a>
    <a href="###" onclick="RemoveLike()" id="removelike"><img alt="like" height="18" src="../../HomePage/Images/11.png"></a>
    <span id="like_span"></span>
    <img alt="view" height="18" src="../../HomePage/Images/2.png">
...
<SharePoint:CssRegistration Name="/sites/bluear/HomePage/Style/Details.css" runat="server"/>
<script src="/sites/bluear/HomePage/Scripts/Details.js" type="text/javascript"></script>
</asp:Content>
